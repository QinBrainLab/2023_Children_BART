...
mask_index={'dACC','DLPFC','VMPFC','NAc','Caudate','Putamen','Amygdala','Insula','Hippocampus'};
num={'1','2','3'};
value_path='/brain/iCAN_admin/home/JiangMin/Neo_BART_2019/Neo_Results/TST_Ace_Value_Activation';
    ...
    for v=1:3
        ...
        for i=1:length(database(:,1))
             ...
             for j=1:length(mask_index)
                mask=strcat('/brain/iCAN_admin/home/JiangMin/Neo_BART_2019/Neo_ROIs/TST_Ace_ROI/TST_',mask_index{1,j},'.nii');  
        ...
        cd(condition_path)
        save TST_Ace_Value_Activation.mat data_mean
    end
end
