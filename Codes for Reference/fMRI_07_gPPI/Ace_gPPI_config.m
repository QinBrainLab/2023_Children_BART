...
% Modified for BART by Shamrockheart on February 11, 2020
%=========================================================================%
clear
restoredefaultpath

% Set Path
SPM_Dir = '/brain/iCAN_admin/home/JiangMin/Toolbox/spm8';
Script_Dir = '/brain/iCAN_admin/home/JiangMin/Neo_BART_2019/Neo_Scripts/Ace_gPPI';

% Please specify the data server path
% paralist.data_server ='/brain/iCAN_admin/home/zhaoyanli/CBD/PreProcessed';   % 

% added by genghaiyang specify the stats server path
paralist.server_path_stats = '/brain/iCAN_admin/home/JiangMin/Results/First_Level';   % 
...
subjlist = fullfile(Script_Dir,'SubList','All_list.txt');   % 

% Please specify the stats folder name (eg., stats_spm8)
paralist.stats_folder = '/BART/stats_spm8_swcar';   % 

% get ROI file list
ROI_form = 'nii';
paralist.roi_nii_folder = '/brain/iCAN_admin/home/JiangMin/Neo_BART_2019/Neo_Scripts/Ace_gPPI/ROI/nii';
